      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="relative ml-2" ref={profileRef}>
          <button 
             ...
             className="flex items-center gap-3 pl-2 border-l border-slate-200 dark:border-slate-700 hover:opacity-80 transition-opacity outline-none"
          >
            ...
            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-600 p-[2px] shadow-lg shadow-blue-500/20 transition-transform hover:scale-105">
          ...
          {/* Profile Dropdown */}
          {showProfileMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden animate-fade-in z-50">
                ...
                <div className="py-1">
                    ...
                    <button 
                        ...
                        className="w-full text-left px-4 py-2 text-sm text-red-500 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors flex items-center gap-2"
                    >
